...
#For s=0.001: arrayuds=( 1 2 5 10 12 15 )
#For s=0.005: arrayuds=( 0.2 1 2 2.5 5 7.5 10 15)
#For s=0.01: arrayuds=( 0.1 0.5 1 2 2.5 5 7.5 10 )
#For s=0.05: arrayuds=( 0.02 0.1 0.2 0.5 1 1.5 2 2.5 5 7.5 10 15)
arraysds=(0.005 0.006 0.007)
...
bentodelratio=0
sb=${arraysds[$SLURM_ARRAY_TASK_ID]}
