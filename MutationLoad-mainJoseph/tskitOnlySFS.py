...
'''
File: tskitOnlySFS.py
Author: Micaila Marcelle
NOTE: This file is ultimately redundant, and does not reflect how the SFS was later 
plotted for the purposes of the paper. Used for initial investigations only
Purpose: The following program builds on the tskit library in order to analyze the succinct
