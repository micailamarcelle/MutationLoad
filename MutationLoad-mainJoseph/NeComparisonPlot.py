...
Purpose: This program is designed to plot three different methods for calculating Ne
(specifically, the formula presented by Cvijovic et al. 2018, Equation 4 from
Matheson & Masel 2024, and T2 / 2N from Eq. 8 in paper). Not ultimately used in 
final paper. 
'''
