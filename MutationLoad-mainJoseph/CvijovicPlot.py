'''
File: CvijovicPlot.py
Author: Micaila Marcelle
Purpose: Plots the SFS distortions according to the model presented by Cvijovic et al.
for a given set of parameters. Ultimately not used within final paper, but used
to gain a deeper understanding of the Cjvijovic model.
'''
